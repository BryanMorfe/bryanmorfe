  ...
  <head>
    ...
    <script src="/js/structure.js"></script>
  	...
  	<?php
		...
		if (isset($success)) {
			echo "<script>";
			echo "$(function() { $(\".form-component\").hide(); emailResponse(" . $success . "); });";
			echo "</script>";
		}
	  
	    if (isset($purpose)) {
			echo "<script>";
			echo "$(function() { $(\"#purpose\").val(\"" . $purpose . "\") });";
			echo "</script>";
		}
	?>
  ...
  <body>
	...
	<main>
 	  ...
 	  <div class="blue-tint">
  	    ...
  	    <div class="main-content">
          <h3 class="form-component">Contact</h3>
          <p class="form-component">All fields are obligatory.</p>
  	  	  <form method="post" action="contact.php" class="form-component">
        ...
        <div class="clearfix footer-nav">
          ...
          <div class="footer-menu">
            ...
            <ul>
              ...
              <li><a href="/contact?purpose=contribution">Become a Contributor</a></li>
              <li><a href="/contact?purpose=network">Are you a developer? Let's Network</a></li>
            </ul>
          </div>
